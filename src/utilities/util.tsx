...
export function getImages(): imageProps[] {
  const library: imageProps[] = [
    ...
    },
    {
      ...
      images:
        "https://res.cloudinary.com/dx1cp4cj9/image/upload/q_60/v1688265871/kijiji_n6ik6j.webp",
      description:
    ...
    },
    {
      ...
      images:
        "https://res.cloudinary.com/dx1cp4cj9/image/upload/q_59/v1688265871/mapto_sjqvs4.webp",
      description:
    ...
    },
    {
      ...
      images:
        "https://res.cloudinary.com/dx1cp4cj9/image/upload/q_60/v1688265875/quizzical_yhewed.webp",
      description:
    ...
    },
    {
      ...
      images:
        "https://res.cloudinary.com/dx1cp4cj9/image/upload/q_59/v1686624516/img_1_wwkwit.webp",
      description:
